...
或者修改参数后运行：
    python train_actor_critic.py --episodes 20000 --save-freq 1000 --use-collected-data
"""

import argparse
import os
import sys
from agent_ActorCritic import ActorCriticAgent, train_actor_critic_agent, train_from_collected_data
import logic
...
def main():
    ...
    parser.add_argument('--save-path', type=str, default='actor_critic_2048_model.pth',
                        help='Path to save model (default: actor_critic_2048_model.pth)')
    ...
    parser.add_argument('--data-dir', type=str, default='collected_data',
                        help='Directory containing collected data (default: collected_data)')
